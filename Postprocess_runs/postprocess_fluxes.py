...
for run in all_runs:
    ...
    outpath = outpath_root+run+'/RadFluxes'
    ...
    stash_dict = {'m01s03i236':'tas',
                  'm01s01i201':'net down surface SW flux: SW TS only',
                  'm01s01i207':'incoming SW flux TOA: ALL TSS',
                  'm01s01i208':'outgoing SW flux TOA',
                  'm01s01i209':'clear-sky upward SW flux TOA',
                  'm01s01i210':'rsdscs',
                  'm01s01i211':'clear-sky SW upward surface flux',
                  'm01s01i235':'rsds',
                  'm01s02i205':'outgoing_LW_rad_flux_TOA',
                  'm01s02i206':'clear-sky_upward_LW_flux_TOA',
                  }
